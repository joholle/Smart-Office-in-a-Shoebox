...
open_window = Action(
    ...
    parameters=[],
    precondition=
        (GreaterEqualThan(humidity, NumericValue(HUMIDITY_THRESHOLD)) | GreaterEqualThan(inside_temp, NumericValue(TEMPERATURE_THRESHOLD)))
        & (Not(is_raining) | LesserThan(water_level, NumericValue(WATER_LEVEL_THRESHOLD)))
        & GreaterEqualThan(inside_temp, outside_temp)
        & Not(windows_open)
...
close_window = Action(
    ...
    precondition=
        ...
        | (is_raining & GreaterEqualThan(water_level, NumericValue(WATER_LEVEL_THRESHOLD)))
...
turn_on_cooler = Action(
    ...
    parameters=[],
    precondition=
        (GreaterEqualThan(inside_temp, NumericValue(TEMPERATURE_THRESHOLD))
        & LesserThan(inside_temp, outside_temp))
        & Not(air_cooler_on)
