(define (problem pleasant_office_room)
    ...
    (:init (= (humidity) 15) (= (inside_temp) 15) (= (light) 5) (= (outside_temp) 5) (= (water_level) 5) (air_cooler_on) (light_on) (not (force_cooler)) (not (force_light)) (not (force_water)) (not (force_window)) (not (is_raining)) (water_spender_on) (windows_open))
