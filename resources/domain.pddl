(define (domain office_room)
    ...
    (:action close_window
        :parameters ()
        :precondition (and (or (and (< (humidity) 40) (< (inside_temp) 22)) (and (is_raining) (>= (water_level) 100)) (< (inside_temp) (outside_temp))) (windows_open) (= (force_window) 1))
     ...
     (:action no_action
        :parameters ()
        :precondition (not (or (and (< (light) 70) (not (light_on)) (= (force_light) 1)) (and (not (light_on)) (= (force_light) 2)) (and (light_on) (= (force_light) 0)) (and (or (>= (humidity) 40) (>= (inside_temp) 22)) (or (not (is_raining)) (< (water_level) 100)) (>= (inside_temp) (outside_temp)) (not (windows_open)) (= (force_window) 1)) (and (or (and (< (humidity) 40) (< (inside_temp) 22)) (and (is_raining) (>= (water_level) 100)) (< (inside_temp) (outside_temp))) (windows_open) (= (force_window) 1)) (and (windows_open) (= (force_window) 0)) (and (not (windows_open)) (= (force_window) 2)) (and (>= (inside_temp) 22) (< (inside_temp) (outside_temp)) (not (air_cooler_on)) (= (force_cooler) 1)) (and (or (< (inside_temp) 22) (>= (inside_temp) (outside_temp))) (air_cooler_on) (= (force_cooler) 1)) (and (not (air_cooler_on)) (= (force_cooler) 2)) (and (air_cooler_on) (= (force_cooler) 0))))
        :effect (no_action_possible)
    )
     (:action open_window
        :parameters ()
        :precondition (and (or (>= (humidity) 40) (>= (inside_temp) 22)) (or (not (is_raining)) (< (water_level) 100)) (>= (inside_temp) (outside_temp)) (not (windows_open)) (= (force_window) 1))
        :effect (and (windows_open) (window_action_done))
    )
