(define (domain office_room)
    ...
    (:action close_window
        :parameters ()
        :precondition (and (or (and (< (humidity) 10) (< (inside_temp) 10) (windows_open)) (and (> (water_level) 0) (is_raining) (windows_open)) (and (< (inside_temp) (outside_temp)) (windows_open))) (= (force_window) 1))
     ...
     (:action no_action
        :parameters ()
        :precondition (or (not (or (and (< (light) 200) (not (light_on)) (= (force_light) 1)) (and (not (light_on)) (= (force_light) 2)) (and (light_on) (= (force_light) 0)) (and (or (> (humidity) 10) (> (inside_temp) 10)) (not (is_raining)) (> (inside_temp) (outside_temp)) (not (windows_open)) (= (force_window) 1)))) (and (< (humidity) 10) (< (inside_temp) 10) (windows_open)) (and (> (water_level) 0) (is_raining) (windows_open)) (and (< (inside_temp) (outside_temp)) (windows_open) (= (force_window) 1)) (and (not (windows_open)) (= (force_window) 2)) (and (windows_open) (= (force_window) 0)) (and (> (inside_temp) 10) (< (inside_temp) (outside_temp)) (not (air_cooler_on)) (= (force_cooler) 1)) (and (or (< (inside_temp) 10) (> (inside_temp) (outside_temp))) (air_cooler_on) (= (force_cooler) 1)) (and (not (air_cooler_on)) (= (force_cooler) 2)) (and (air_cooler_on) (= (force_cooler) 0)))
        :effect (no_action_possible)
    )
     (:action open_window
        :parameters ()
        :precondition (and (or (> (humidity) 10) (> (inside_temp) 10)) (not (is_raining)) (> (inside_temp) (outside_temp)) (not (windows_open)) (= (force_window) 1))
        :effect (and (windows_open) (window_action_done))
    )
     (:action turn_off_cooler
        :parameters ()
        :precondition (and (or (< (inside_temp) 10) (> (inside_temp) (outside_temp))) (air_cooler_on) (= (force_cooler) 1))
        :effect (and (not (air_cooler_on)) (cooler_action_done))
    )
     (:action turn_on_cooler
        :parameters ()
        :precondition (and (> (inside_temp) 10) (< (inside_temp) (outside_temp)) (not (air_cooler_on)) (= (force_cooler) 1))
        :effect (and (air_cooler_on) (cooler_action_done))
    )
     (:action turn_on_light
        :parameters ()
        :precondition (and (< (light) 200) (not (light_on)) (= (force_light) 1))
        :effect (and (light_on) (light_action_done))
    )
)